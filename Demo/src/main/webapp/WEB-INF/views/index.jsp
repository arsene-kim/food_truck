...
//위치 배열에 담기
<c:forEach items="${coordinate}" var="result">
	asd.push("$result.latitude")
	asd.push("$result.longitude")
</c:forEach>
...
for(var i = 0; i < asd.length; i++){
	...
	var marker = new naver.maps.Marker({
	   map: map,
	   position: new naver.maps.LatLng(asd[i].latitude , asd[i].longitude) // 위도 경도 넣기 
	})
};
